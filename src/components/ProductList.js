...
const products = [
    ...
    { id: 8, name: 'Gongura Chickenpickle Pickle', description: 'Savory Gongura Chicken pickle', price: 600, image: '/images/gongurachickenpickle.jpg', category: 'nonveg' },
    ...
    { id: 11, name: 'Naatu Kodi Pickle', description: 'Savory Naatu Kodi pickle', price: 110, image: '/images/naatukodi.png', category: 'veg' },
    ...
    { id: 17, name: 'Tamarind Pickle', description: 'Savory Tamarind pickle', price: 110, image: '/images/tamarind.png', category: 'veg' },
  ...
  const ProductItem = ({ product }) => {
    ...
    const decrementCount = () => {
      setCount(prevCount => {
        if (prevCount === 1) return 0; // Reset to "Add to Cart" if it reaches zero
        return prevCount - 1;
      });
    };
